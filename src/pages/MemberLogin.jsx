...
export default function MemberLogin() {
  ...
  // If already logged in, go to unified app
  useEffect(() => {
    if (memberSession) {
    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#0a0a0f" }}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground">TeamOS</h1>
          <p className="text-muted-foreground text-sm mt-1">Sign in with your team credentials</p>
        </div>
